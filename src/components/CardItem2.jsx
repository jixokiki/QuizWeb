...
const CardItem2 = ({
  ...
  const handleAddToQuiz2 = () => {
    router.push("/quiz2"); // Ganti "/navbar-product" dengan rute yang sesuai
  };
  return (
    <div className="bg-yellow-200 w-full rounded overflow-hidden shadow-lg">
